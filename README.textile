...
If you are setting up raid assignments, however, that can get a bit tedious. To assist with that, you can use the /avgilevel command to bring up the party/raid report window. To report the averages to your group, simply click the "Report" button.

A LibDataBroker launcher is also included that when clicked will open the report window.
