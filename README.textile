...
AvgItemLevel is a simple plug-n-play addon that simply shows the average ItemLevel (iLevel) of your currently equipped gear on the bottom right of the Character and Inspect frames. No configuration required, just install and go.
